...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=== DEMOSTRACION DATA MANAGER CON PERSISTENCIA ===");
        System.out.println("ArrayList inicial (cargado desde BD): " + manager.getTotalProductos() + " productos");
        ...
        manager.aggDatosHistorial(1, "lavadoras", 2, 1, false);
